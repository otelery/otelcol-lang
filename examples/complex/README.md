...
Files are intended to be loaded together with the collector's
...
The extension auto-discovers the same files as a config-set in the
editor: opening any one of them gives you cross-file go-to-definition,
find-references, hover and diagnostics across the whole set.
...
## Things to look for in the editor
