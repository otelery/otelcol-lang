...
Reference report on how JetBrains IntelliJ community plugins integrate LSP language servers that run as Node.js processes. Source repo: `~/project/lab/observability/intellij-plugins` (branch `master`).
...
- `~/project/lab/observability/intellij-plugins/vuejs/vuejs-backend/src/org/jetbrains/vuejs/lang/typescript/service/lsp/VueLspClientHybridModeProvider.kt`
- `~/project/lab/observability/intellij-plugins/vuejs/vuejs-backend/src/org/jetbrains/vuejs/lang/typescript/service/lsp/VueLspClientHybridModeDescriptor.kt`
- `~/project/lab/observability/intellij-plugins/vuejs/vuejs-backend/src/org/jetbrains/vuejs/lang/typescript/service/lsp/VueLspClientTakeoverModeProvider.kt`
- `~/project/lab/observability/intellij-plugins/vuejs/vuejs-backend/src/org/jetbrains/vuejs/lang/typescript/service/lsp/VueLspServerTakeoverModeLoader.kt`
- `~/project/lab/observability/intellij-plugins/vuejs/vuejs-backend/src/org/jetbrains/vuejs/lang/typescript/service/lsp/VueLspServerHybridModeLoaderFactory.kt`
- `~/project/lab/observability/intellij-plugins/vuejs/vuejs-backend/src/org/jetbrains/vuejs/lang/typescript/service/lsp/VueLspServerPackageDescriptor.kt`
- `~/project/lab/observability/intellij-plugins/vuejs/vuejs-backend/src/org/jetbrains/vuejs/lang/typescript/service/lsp/VueHybridModeLsp4jClient.kt`
...
- `~/project/lab/observability/intellij-plugins/Astro/src/org/jetbrains/astro/service/AstroLspClientProvider.kt`
- `~/project/lab/observability/intellij-plugins/Astro/src/org/jetbrains/astro/service/AstroLspTypeScriptService.kt`
- `~/project/lab/observability/intellij-plugins/Astro/src/org/jetbrains/astro/service/AstroServices.kt`
- `~/project/lab/observability/intellij-plugins/Astro/src/org/jetbrains/astro/service/settings/AstroServiceConfigurable.kt`
- `~/project/lab/observability/intellij-plugins/Astro/src/org/jetbrains/astro/service/settings/AstroServiceSettings.kt`

`AstroServices.kt` contains `AstroLspServerPackageDescriptor` (bundled `@astrojs/language-server`) and `AstroLspServerLoader`.

### Prisma (`prisma`)

- `~/project/lab/observability/intellij-plugins/prisma/src/org/intellij/prisma/ide/lsp/PrismaLspClientDescriptor.kt`
- `~/project/lab/observability/intellij-plugins/prisma/src/org/intellij/prisma/ide/lsp/PrismaLspClientProvider.kt`
- `~/project/lab/observability/intellij-plugins/prisma/src/org/intellij/prisma/ide/lsp/PrismaServiceSettings.kt`
...
- `~/project/lab/observability/intellij-plugins/Deno/src/com/intellij/deno/service/DenoLspClientDescriptor.kt`
...
- Vue: `~/project/lab/observability/intellij-plugins/vuejs/vuejs-backend/vue-language-tools/language-server/<version>/bin/vue-language-server.js`
...
- Astro: `~/project/lab/observability/intellij-plugins/Astro/astro-language-server/` — `.gitignore` excludes `node_modules` and `*.js.map`; README references `WEB-68605 Bundle Vue, Svelte, Astro language servers`.
- Prisma: `~/project/lab/observability/intellij-plugins/prisma/language-server/` (source/build) and `~/project/lab/observability/intellij-plugins/prisma/gen-resources/language-server/` (built artefacts — `prisma-language-server.js`, `prisma-fmt.js`, `prisma_schema_build_bg.wasm`). Built via webpack: `prisma:lsp` script → `webpack --config webpack.config.js`.
...
Repo: `~/project/lab/observability/sonarlint-intellij`
...
- Backend launcher / lifecycle:
  - `~/project/lab/observability/sonarlint-intellij/src/main/java/org/sonarlint/intellij/core/BackendService.kt`
...
- Restart action: `~/project/lab/observability/sonarlint-intellij/src/main/java/org/sonarlint/intellij/actions/RestartBackendAction.kt`
- Node discovery (extension point):
  - SPI: `~/project/lab/observability/sonarlint-intellij/common/src/main/java/org/sonarlint/intellij/common/nodejs/NodeJsProvider.kt`
  - JS-plugin-backed impl: `~/project/lab/observability/sonarlint-intellij/nodejs/src/main/java/org/sonarlint/intellij/nodejs/JavaScriptNodeJsProvider.kt`
- User-facing Node settings: `~/project/lab/observability/sonarlint-intellij/src/main/java/org/sonarlint/intellij/config/global/NodeJsSettings.kt`
- Gradle wiring that downloads + unpacks the backend: `~/project/lab/observability/sonarlint-intellij/build.gradle.kts`
